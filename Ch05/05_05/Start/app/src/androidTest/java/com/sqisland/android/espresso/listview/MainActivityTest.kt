...
class MainActivityTest {
  ...
  fun clickItem() {
    ...
    // Look for the data item that has the value "27",
    // specify our adapter on the screen, and click on the item
    onData(withValue(27))
            .inAdapterView(withId(R.id.list))
            .perform(click())

    // Locate the footer and make sure it and
    // the text displayed is 27
    onView(withId(R.id.footer))
